...
function Upload(){
    ...
    function imageCard(obj,k,lcK,content=null){
        return(
            <div key={k} className="image-div">
                <div heading="Image div" showCard={false} showHeading={false} showBr={false}>
    ...
    return(
        <div>
            <div heading="Upload New Content" showCard={false} showHeading={true} showBr={true}>
                <div className="upload-button-holder">
                    <Button variant="primary" onClick={uploadImg}>Upload Image</Button>
                </div>

                <div heading="Upload New Content" showCard={false} showHeading={false} showBr={false}>
                    ...
                    <div className="new-img-upload">
                        {eventPr > 0 &&
                            ...
                            Object.keys(localStorage).map((obj,idx)=>{
                                console.log(obj);
                                return (imageCard(localStorage.getItem(obj),idx,obj));
                            })
                        }
                    </div>
                </div>
